                ...
                <div class="mt-14 grid md:grid-cols-3 gap-8">
                    @php
                        $steps = [
                            ...
                            ['n' => '2', 'title' => 'Επιλέξτε ώρα', 'text' => 'Δείτε τη διαθεσιμότητα κάθε εκπαιδευτικού σε πραγματικό χρόνο και κλείστε ένα ραντεβού με λίγα κλικ.'],
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-14 grid md:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-7">
                        ...
                        <ul class="mt-3 space-y-2 text-sm text-slate-500">
                            <li>&bull; Ορίστε τη διαθεσιμότητά σας</li>

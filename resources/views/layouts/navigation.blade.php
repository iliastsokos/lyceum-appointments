        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 sm:gap-2">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white/90 bg-transparent hover:text-white focus:outline-none focus:ring-2 focus:ring-[#f2952b] focus:ring-offset-2 focus:ring-offset-[#0e6e73] transition ease-in-out duration-150">

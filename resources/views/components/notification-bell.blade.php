<div x-data="{ count: {{ $unreadCount }} }"
    ...
    <x-dropdown align="right" width="w-80">
        <x-slot name="trigger">
            <button class="relative inline-flex items-center p-2 rounded-md text-gray-500 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150" aria-label="{{ __('Notifications') }}">
        ...
        <x-slot name="content">
            ...
            @empty
                <div class="px-4 py-6 text-sm text-gray-500 text-center">{{ __('No notifications yet.') }}</div>
            @endforelse

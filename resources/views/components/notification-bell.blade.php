<div x-data="{ count: {{ $unreadCount }} }"
    ...
    <x-dropdown align="right" width="w-80">
        <x-slot name="trigger">
            <button class="relative inline-flex items-center p-2 rounded-md text-white/90 hover:text-white focus:outline-none focus:ring-2 focus:ring-[#f2952b] focus:ring-offset-2 focus:ring-offset-[#0e6e73] transition ease-in-out duration-150" aria-label="{{ __('Ειδοποιήσεις') }}">
